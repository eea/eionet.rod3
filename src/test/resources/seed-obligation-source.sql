...
INSERT INTO T_SOURCE_TYPE
values (15, 'Agreement', 1);
...
INSERT INTO T_CLIENT_SOURCE_LNK (FK_CLIENT_ID, FK_SOURCE_ID, STATUS)
VALUES (1, 1, 'M'),
       (2, 2, 'C');
...
INSERT INTO T_RASPATIAL_LNK
VALUES (1, 1, 'N'),
       (1, 2, 'Y');

DELETE
FROM T_ROLE;
INSERT INTO T_ROLE (ROLE_NAME, ROLE_ID)
VALUES ('National Focal Points', 'eionet-nrc-waterquality');

DELETE
FROM T_CLIENT_OBLIGATION_LNK;
INSERT INTO T_CLIENT_OBLIGATION_LNK
VALUES (1, 2, 'C'),
       (1, 1, 'M'),
       (1, 1, 'C');

INSERT INTO T_SOURCE_LNK
SET PK_SOURCE_LNK_ID    ='1',
...
INSERT INTO T_OBLIGATION_RELATION (FK_RA_ID, RELATION, FK_RA_ID2)
VALUES (1, 'Replaces', 2);
